...
1. The first step will be downloading the datapack off course. You will be putting the datapack in the following position: 
...
<br />
2. When you go in to the data map from the datapack. You will see three maps. <br />
If you want the library in your own pack you only have the copy the map named `thi_key_library`.